...
import java.util.Scanner;
    ...
    public class UIMenu {
        ...
        private static void authUser(int userType){
            ...
            doctors.add(new Doctor("Alejandro Martinez", "Alejo@mail.com"));
            doctors.add(new Doctor("Karen Sosa", "KKarem@mail.com"));
            doctors.add(new Doctor("Rocio Gomez", "Rocio@mail.com"));

            ArrayList<Patient> patients = new ArrayList<>();
            patients.add(new Patient("Luis Viera", "luis@mail.com"));
